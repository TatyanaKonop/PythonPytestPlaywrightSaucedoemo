...
class Base:
    ...
    def click(self, locator, click_count: int = 1):
        self.page.locator(locator).click(click_count=click_count)
    ...
    def close_tab(self,
                  number):  # закрываем таб и возвращаемся на предыщущий, number-номер таба который хотим закрыть
